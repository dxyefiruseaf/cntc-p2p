...
type PageData = { count?: number; data?: Array<Record<string, unknown>>; next_cursor?: string; has_next?: boolean; portfolio?: Record<string, unknown> };
...
export default function History() {
  ...
  const changeTab = (value: Tab) => { setTab(value); setCursorStack([null]); setPageIndex(0); setSearch(''); };
  const next = () => {
